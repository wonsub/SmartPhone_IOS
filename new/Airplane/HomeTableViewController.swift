...
//  Airplane
//
//  Created by kpu_game on 2017. 6. 14..
...
class HomeTableViewController: UITableViewController, XMLParserDelegate {
    ...
    func beginParsing(){
        ...
        parser = XMLParser(contentsOf:(NSURL(string:"http://openapi.airport.co.kr/service/rest/FlightScheduleList/getDflightScheduleList?serviceKey=Ky%2BwXkscu67T8fzT8JNNCSHphmixtovXBdUJq7mu6UpqCcZf7HLqA%2F8bjU%2FHijQ4Vi4zmtjF9Kp3LtjgUgHvTg%3D%3D&numOfRows=2000"))! as URL)!
